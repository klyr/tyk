...
func processSpec(referenceSpec *APISpec,
	...
	if referenceSpec.UseKeylessAccess {
		...
		AppendMiddleware(&baseChainArray, &TransformKazaamMiddleware{tykMiddleware}, tykMiddleware)
		...
		AppendMiddleware(&baseChainArray_PostAuth, &TransformKazaamMiddleware{tykMiddleware}, tykMiddleware)
